...
class BaseServerProxy(object):
    ...
    def __init__(
            ...
            keepalive_timeout=None, use_dns_cache=None, ttl_dns_cache=None,
            **kwargs):
        self.uri = uri
        ...
        self.keepalive_timeout = (
            60.0 if keepalive_timeout is None else keepalive_timeout)
    ...
    async def call(self, name, *args):
        try:
            ...
            headers = self.serializer.prepare_request_headers()
            headers.update({
